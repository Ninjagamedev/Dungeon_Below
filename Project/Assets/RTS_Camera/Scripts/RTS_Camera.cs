...
namespace RTS_Cam
{
    ...
    public class RTS_Camera : MonoBehaviour
    {
        ...
        public float maxHeight = 1f; //maximal height
        public float minHeight = 2f; //minimnal height
        ...
        private void LimitPosition()
        {
            ...
            m_Transform.position = new Vector3(Mathf.Clamp(m_Transform.position.x, -limitX, limitX/1.5f),
                m_Transform.position.y,
                Mathf.Clamp(m_Transform.position.z, -limitY/4, limitY));
        }
